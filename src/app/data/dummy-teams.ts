...
export const DUMMY_TEAMS: Team[] = [
  ...
  { id: '00000000-0000-0000-0000-000000000002', name: 'Card Sharks',       player1: 'Eve',     player2: 'Frank' },
  { id: '00000000-0000-0000-0000-000000000003', name: 'The Jokers',        player1: 'Grace',   player2: 'Hank' },
  { id: '00000000-0000-0000-0000-000000000004', name: 'Diamond Kings',     player1: 'Iris',    player2: 'Jack' },
  { id: '00000000-0000-0000-0000-000000000005', name: 'Spade Warriors',    player1: 'Karen',   player2: 'Leo' },
  { id: '00000000-0000-0000-0000-000000000006', name: 'Heart Breakers',    player1: 'Mia',     player2: 'Nick' },
  { id: '00000000-0000-0000-0000-000000000007', name: 'Club Masters',      player1: 'Olivia',  player2: 'Paul' },
  { id: '00000000-0000-0000-0000-000000000008', name: 'Wild Cards',        player1: 'Quinn',   player2: 'Rachel' },
